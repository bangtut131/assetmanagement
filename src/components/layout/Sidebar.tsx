...
import { LayoutDashboard, List, Map, FileCheck, Box, Download, Settings, LogOut, ChevronRight } from "lucide-react";
...
export function Sidebar() {
    ...
    const { currentUser, hasPermission, isSettingsOpen, openSettings, closeSettings } = useStore();
    ...
    return (
        <aside className="hidden md:flex flex-col w-72 bg-[#0f172a] text-slate-300 h-screen sticky top-0 border-r border-slate-800 shadow-2xl z-50">
            {/* Brand Section */}
            {/* Brand Section */}
            <div className="p-6 flex flex-col items-center gap-3 text-center border-b border-slate-800/50 mb-4">
